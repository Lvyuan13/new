...
namespace SHHS.UILabs
{
    public class Channel : INotifyPropertyChanged
    {
        ...
        /// Channel初始化
        /// </summary>
        /// <param name="no">显示序号</param>
        /// <param name="redNo">对应记录仪通道号</param>
        /// <param name="name">名称</param>
        /// <param name="filter">过滤器</param>
        /// <param name="unit">单位</param>
        /// <param name="unitDesc">单位描述</param>
        /// <param name="type">通道类别</param>
        /// <param name="precision">数据精度</param>
        /// <param name="maximum">最大数字量</param>
        /// <param name="minimum">最小数字量</param>
        /// <param name="maxAnalog">最大模拟量</param>
        /// <param name="minAnalog">最小模拟量</param>
